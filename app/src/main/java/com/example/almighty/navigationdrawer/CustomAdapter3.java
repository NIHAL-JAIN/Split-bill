...
public class CustomAdapter3 extends BaseAdapter {
    ...
    Context context;
    public CustomAdapter3(GroupsDetails showSavings, ArrayList<String> showsavings5, ArrayList<String> showsavings1, ArrayList<String> showsavings2, ArrayList<String> showsavings3, ArrayList<String> showsavings4){
        context=showSavings;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View Rowview;
        Rowview=layoutInflater.inflate(R.layout.activity_customlist3,null);
