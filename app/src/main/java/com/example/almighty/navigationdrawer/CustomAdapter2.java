...
public class CustomAdapter2 extends BaseAdapter {
    ...
    Context context;
    public CustomAdapter2(Self showSavings, ArrayList<String> showsavings1, ArrayList<String> showsavings2, ArrayList<String> showsavings3, ArrayList<String> showsavings4){
        context=showSavings;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View Rowview;
        Rowview=layoutInflater.inflate(R.layout.activity_customlist2,null);
